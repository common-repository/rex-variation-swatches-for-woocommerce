<?php
/**
 * Contains Rexvs_Dependency_Check class. and wps_extend_plugins function.
 *
 * @package    WPS_Core
 ...
 */
if ( !class_exists('Rexvs_Dependency_Check') ) {
    /**
     * Class Rexvs_Dependency_Check
     *
...
//                        $this->min_version,
//                        $current
                        __( 'Sorry, but Variation Swatches for %s requires %s to be installed and active.', $this->text_domain ),
                        $dependency,
                        $dependency
