...
//     this.start = function () {
//       var that = this;
//       //console.log(this._variation_form.find('.rexvs-swatches'))
//       this._variation_form.find('.rexvs-swatches').each(function () {
//         //console.log("hello wordpress")
//         var attribute = $(this),
//             wc_select = attribute.parent().find('.variation-selector'),
//             wc_select_two = wc_select.find('select');
//
//           attribute.on('touchstart click', '.swatch', function (e) {
//            e.preventDefault();
//            e.stopPropagation();
//            var self = $(this),
//               is_selected = self.hasClass('selected'),
//                term = self.data('value');
//
...
//           // }
//
//             wc_select_two.val(term).trigger('change').trigger('click').trigger('focusin');
//
//
//           if (that._is_mobile) {
